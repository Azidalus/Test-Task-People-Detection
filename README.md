# Описание проекта
В этом репозитории лежит программа по детекции людей на тестовом видео crowd.mp4, а также dockerfile для возможности запуска программы на любой машине (Windows, Linux, MacOS) с помощью Docker.
